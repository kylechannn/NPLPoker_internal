            ...
            foreach ((array) ($seating['tables'] ?? []) as $table) {
                ...
                foreach ((array) ($table['seats'] ?? []) as $seat) {
                    ...
                    $rows[] = [
                        ...
                        'gather_starts_at' => $this->str($table['gather_starts_at'] ?? null, 40),
                        ...
                        'hold_expires_at' => $player ? $this->str($player['hold_expires_at'] ?? null, 40) : null,
                        'checked_in' => $player ? (bool) ($player['checked_in'] ?? false) : null,
