...
Route::prefix('v1/desk')->controller(\App\Http\Controllers\Api\DeskController::class)->group(function (): void {
    ...
    Route::post('sessions/{gameSessionId}/tables/{tableNumber}/state', 'setCloudTableState')->whereNumber('gameSessionId')->whereNumber('tableNumber');
    Route::post('sessions/{gameSessionId}/tables/{tableNumber}/timer', 'setCloudTableTimer')->whereNumber('gameSessionId')->whereNumber('tableNumber');
